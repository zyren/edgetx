...
#elif defined(RADIO_TX12) || defined(RADIO_TX12MK2) || defined(RADIO_BOXER) || defined(RADIO_ZORRO) || defined(RADIO_MT12)
...
// Rotary Encoder
  ...
  #endif
  #if defined(RADIO_TX12MK2) || defined(RADIO_BOXER) || defined(RADIO_ZORRO) || defined(RADIO_MT12)
...
// Switches
...
#elif defined(RADIO_MT12)
  // TODO: this need to be moved to mixed swicth/pot
  #define STORAGE_SWITCH_E
  #define HARDWARE_SWITCH_E
  #define SWITCHES_GPIO_REG_E           GPIOA
  #define SWITCHES_GPIO_PIN_E           LL_GPIO_PIN_5 // PA.05
  ...
  #define SWITCHES_GPIO_PIN_F           LL_GPIO_PIN_6 // PA.06
#elif defined(RADIO_TPRO)
  // SW2
...
#elif defined(PCBX7) || defined(PCBXLITE) || defined(PCBX9LITE)  || defined(RADIO_T8) || defined(RADIO_COMMANDO8) || defined(RADIO_MT12)
  // no SWG
#else
  #define STORAGE_SWITCH_G
  #define HARDWARE_SWITCH_G
...
#elif defined(RADIO_MT12)
  #define KEYS_RCC_AHB1Periph           (RCC_AHB1Periph_GPIOA|RCC_AHB1Periph_GPIOB|RCC_AHB1Periph_GPIOC|RCC_AHB1Periph_GPIOD|RCC_AHB1Periph_GPIOE)
  #define KEYS_GPIOA_PINS               (KEYS_GPIO_PIN_ENTER | SWITCHES_GPIO_PIN_E | SWITCHES_GPIO_PIN_F)
  #define KEYS_GPIOB_PINS               (KEYS_GPIO_PIN_SYS)
  #define KEYS_GPIOC_PINS               (KEYS_GPIO_PIN_EXIT | TRIMS_GPIO_PIN_T1R | TRIMS_GPIO_PIN_T1L | SWITCHES_GPIO_PIN_C | SWITCHES_GPIO_PIN_D)
  #define KEYS_GPIOD_PINS               (KEYS_GPIO_PIN_PAGEUP | KEYS_GPIO_PIN_PAGEDN | KEYS_GPIO_PIN_TELE | SWITCHES_GPIO_PIN_B)
  #define KEYS_GPIOE_PINS               (KEYS_GPIO_PIN_MDL | TRIMS_GPIO_PIN_T2R | TRIMS_GPIO_PIN_T2L | TRIMS_GPIO_PIN_T3R | TRIMS_GPIO_PIN_T3L | TRIMS_GPIO_PIN_T4R | TRIMS_GPIO_PIN_T4L | TRIMS_GPIO_PIN_T5R | TRIMS_GPIO_PIN_T5L | SWITCHES_GPIO_PIN_A_H | SWITCHES_GPIO_PIN_A_L)
#elif defined(RADIO_T8)
  #define KEYS_RCC_AHB1Periph           (RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOB | RCC_AHB1Periph_GPIOC | RCC_AHB1Periph_GPIOD | RCC_AHB1Periph_GPIOE)
...
#define ADC_CHANNEL_RTC_BAT             LL_ADC_CHANNEL_VBAT
  ...
  #define ADC_GPIOA_PINS                (ADC_GPIO_PIN_STICK_TH | ADC_GPIO_PIN_STICK_ST | ADC_GPIO_PIN_POT1 | ADC_GPIO_PIN_POT2)
  #define ADC_GPIOC_PINS                (ADC_GPIO_PIN_BATT)
  #define ADC_VREF_PREC2                330
#elif defined(PCBX7)
  #define HARDWARE_POT1
...
// External Module
#if defined(PCBXLITE) || defined(PCBX9LITE) || defined(RADIO_X9DP2019) || defined(PCBX7ACCESS) || defined(RADIO_ZORRO) || defined(RADIO_TX12MK2) || defined(RADIO_BOXER) || defined(RADIO_MT12)
  #if defined(RADIO_X9DP2019) || defined(RADIO_X7ACCESS) || defined(RADIO_ZORRO) || defined(RADIO_TX12MK2) || defined(RADIO_BOXER) || defined(RADIO_MT12)
...
// Trainer / Trainee from the module bay
    ...
    defined(PCBX7ACCESS) || defined(RADIO_ZORRO) || defined(RADIO_TX12MK2) || defined(RADIO_BOXER) || defined(RADIO_MT12)
...
// LCD driver
#if defined(RADIO_TX12) || defined(RADIO_TX12MK2) || defined(RADIO_BOXER) || defined(RADIO_ZORRO) || defined(RADIO_FAMILY_JUMPER_T12) || defined(RADIO_T8) || defined(RADIO_COMMANDO8) || defined(RADIO_TPRO) || defined(RADIO_MT12)
...
#elif defined(RADIO_TX12) || defined(RADIO_TX12MK2) || defined(RADIO_ZORRO) || defined(RADIO_BOXER) || defined(RADIO_T8) || defined(RADIO_TLITE) || defined(RADIO_TPRO) || defined(RADIO_LR3PRO) || defined(RADIO_MT12)
...
// Haptic
#if defined(PCBXLITE) || defined(PCBX9LITE) || defined(RADIO_ZORRO) || defined(RADIO_TX12MK2)|| defined(RADIO_BOXER) || defined(RADIO_MT12)
  #define HAPTIC_PWM
